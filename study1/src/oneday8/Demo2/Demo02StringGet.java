...
//        StringDemo3();
    ...
    public static void StringDemo2(){
        ...
        System.out.println("字符串的截取1："+ str1.substring(3));
        System.out.println("字符串的截取2："+ str1.substring(1,3));
    ...
    public static void  StringDemo3(){
        ...
        System.out.println("转换为字符数组："+chars[0]); // H
        ...
        for (int i = 0; i < bytes.length; i++) {
            System.out.println("转换成为字节数组" + bytes[i]);
        }
        System.out.println("==============");
        ...
        System.out.println("字符串内容替换前："+str1+"字符串内容替换后"+ str2); // How do you do?
        System.out.println("==============");
